...
export const lastTemperature = (req, res, next) => {
  axios
    ...
    .then(({ data }) => {
      res
        .status(200)
        .json({ ...data, feed_key: "temperature", message: "successful" });
    })
    .catch((error) => {
      res.status(400);
...
export const lastHumidity = (req, res, next) => {
  axios
    ...
    .then(({ data }) => {
      res
        .status(200)
        .json({ ...data, feed_key: "humidity", message: "successful" });
    })
    .catch((error) => {
      res.status(400);
      next(new Error(error.message));
...
export const lastSoildMoisture = (req, res, next) => {
  axios
    ...
    .then(({ data }) => {
      res
        .status(200)
        .json({ ...data, feed_key: "soild-moisture", message: "successful" });
    })
    .catch((error) => {
      res.status(400);
      next(new Error(error.message));
...
export const lastFan = (req, res, next) => {
  axios
    ...
    .then(({ data }) => {
      res.status(200).json({ ...data, feed_key: "fan", message: "successful" });
    })
    .catch((error) => {
      res.status(400);
      next(new Error(error.message));
...
export const lastLight = (req, res, next) => {
  axios
    ...
    .then(({ data }) => {
      res
        .status(200)
        .json({ ...data, feed_key: "light", message: "successful" });
    })
    .catch((error) => {
      res.status(400);
      next(new Error(error.message));
...
export const lastMode = (req, res, next) => {
  axios
    ...
    .then(({ data }) => {
      res
        .status(200)
        .json({ ...data, feed_key: "mode", message: "successful" });
    })
    .catch((error) => {
      res.status(400);
      next(new Error(error.message));
...
export const lastPump = (req, res, next) => {
  axios
    ...
    .then(({ data }) => {
      res
        .status(200)
        .json({ ...data, feed_key: "pump", message: "successful" });
    })
    .catch((error) => {
      res.status(400);
      next(new Error(error.message));
